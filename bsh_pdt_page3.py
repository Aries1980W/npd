...
#         st.write(temp)
    ...
    # df_pdt['image']=pd.DataFrame(image)

    return df_pdt,kw_word,pic_code
...
for key_word in pdt_code:
    ...
    try:
        ...
        df_pdt_detail,kw_words,image = get_pdt_detail(key_word)
        df_pdt_detail_total=pd.concat([df_pdt_detail_total,df_pdt_detail])
